...
export default function GroupCard({ group }: { group: Group }) {
  ...
  return (
    <Link href={`/group/${group._id}`}>
      <article className="glass-card overflow-hidden hover:border-primary/30 transition-all duration-300 hover:glow-orange hover:-translate-y-0.5 group cursor-pointer h-full flex flex-col">
        {/* Image */}
